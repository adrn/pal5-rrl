...
The Palomar 5 stellar stream (Pal 5) is an exemplar stream within the Milky Way: Its $\approx 20\degr$ tidal tails connect back to the progenitor cluster, and it has been used to study the shape and total mass of, along with substructure in, the dark matter distribution of the Galaxy.
...
% Aims
Here we aim to measure distance and kinematic properties along the Pal 5 stream in order to motivate improved models of the Pal 5 stream.
