...
\todo{Cecilia: write this paragraph? you probably have some canned text?}
RR Lyrae stars (RRLs) are pulsating horizontal branch stars that are intrinsically more luminous than main sequence stars, but about $\sim 10,000$ time less numerous. 
HB = good distance indicator.
The horizontal branch in Pal 5 is bright enough to be observed by Gaia, meaning we can measure kinematic properties of the full stream...
